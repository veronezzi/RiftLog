...
import com.example.riftlog.databinding.FragmentProfileBinding
import com.example.riftlog.domain.model.PlayerProfile
import com.example.riftlog.domain.model.RankEntry
import com.example.riftlog.ui.common.RankTierColor
...
class ProfileFragment : Fragment(R.layout.fragment_profile) {
    ...
    private fun bindRankCard(
        rankCardBinding: com.example.riftlog.databinding.ViewRankCardBinding,
        queueLabel: String,
        rank: RankEntry?,
    ) {
